...
get_filename_component(_filename "/home/unitree/HongTu/G1Nav2D/src/fastlio2/srv/SlamReLoc.srv" NAME_WE)
add_custom_target(_fastlio_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fastlio" "/home/unitree/HongTu/G1Nav2D/src/fastlio2/srv/SlamReLoc.srv" ""
)

get_filename_component(_filename "/home/unitree/HongTu/G1Nav2D/src/fastlio2/srv/SaveMap.srv" NAME_WE)
add_custom_target(_fastlio_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fastlio" "/home/unitree/HongTu/G1Nav2D/src/fastlio2/srv/SaveMap.srv" ""
)

get_filename_component(_filename "/home/unitree/HongTu/G1Nav2D/src/fastlio2/srv/MapConvert.srv" NAME_WE)
add_custom_target(_fastlio_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fastlio" "/home/unitree/HongTu/G1Nav2D/src/fastlio2/srv/MapConvert.srv" ""
)

get_filename_component(_filename "/home/unitree/HongTu/G1Nav2D/src/fastlio2/srv/SlamHold.srv" NAME_WE)
add_custom_target(_fastlio_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fastlio" "/home/unitree/HongTu/G1Nav2D/src/fastlio2/srv/SlamHold.srv" ""
)

get_filename_component(_filename "/home/unitree/HongTu/G1Nav2D/src/fastlio2/srv/SlamStart.srv" NAME_WE)
add_custom_target(_fastlio_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fastlio" "/home/unitree/HongTu/G1Nav2D/src/fastlio2/srv/SlamStart.srv" ""
)

get_filename_component(_filename "/home/unitree/HongTu/G1Nav2D/src/fastlio2/srv/SlamRelocCheck.srv" NAME_WE)
add_custom_target(_fastlio_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "fastlio" "/home/unitree/HongTu/G1Nav2D/src/fastlio2/srv/SlamRelocCheck.srv" ""
)
